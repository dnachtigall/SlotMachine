...
//  SlotMachine
//
//  Created by David Nachtigall on 01.01.15.
...
class ViewController: UIViewController {
    ...
    func betOneButtonPressed (button: UIButton) {
        ...
        if credits <= 0 {
            showAlterWithText(header: "No more Credits", message: "Reset Game")
        }
        else {
            if currentBet < 5 {
                currentBet += 1
                ...
                showAlterWithText(message: "You can only bet 5 credits at a time")
            }
        }
    }
    ...
    func betMaxButtonPressed (button: UIButton) {
        if credits <= 5 {
            self.showAlterWithText(header: "Not enough credits.", message: "Bet Less")
        }
            else {
                if currentBet < 5 {
    ...
    func setupContainerViews() {
        ...
        self.fourthContainer = UIView(frame: CGRect(x: self.view.bounds.origin.x + kMarginForView, y: self.firstContainer.frame.height + self.secondContainer.frame.height + thirdContainer.frame.height, width: self.view.bounds.width - (2 * kMarginForView), height: self.view.bounds.height * kSixth))
    ...
    func setupSecondContainer (containerView: UIView) {
        ...
        for var containerNumber = 0; containerNumber < kNumberOfContainers; ++containerNumber {
            ...
            for var slotNumber = 0; slotNumber < kNumberOfSlots; slotNumber++ {
                ...
                if slots.count != 0 {
                    let slotContainer:Array = slots[containerNumber]
    ...
    func setupThirdContainer (containerView: UIView) {
        ...
        self.creditsLabels = UILabel()
        self.creditsLabels.text = "000000"
        self.creditsLabels.textColor = UIColor.redColor()
        self.creditsLabels.font = UIFont(name: "Menlo-Bold", size: 16)
        self.creditsLabels.sizeToFit()
        self.creditsLabels.center = CGPoint(x: containerView.frame.width * kSixth, y: containerView.frame.height * kThird)
        self.creditsLabels.textAlignment = NSTextAlignment.Center
        self.creditsLabels.backgroundColor = UIColor.darkGrayColor()
        containerView.addSubview(self.creditsLabels)
    ...
    func updateMainView () {
        self.creditsLabels.text = "\(credits)"
        self.betLabel.text = "\(currentBet)"
        self.winnerPaidLabel.text = "\(winnings)"
    }
    
    func showAlterWithText (header : String = "Warning", message : String) {
